...
I first tried this problem with a back tracking approach.

This code was what I intended. It is not my solution.
...
But I could not help myself from trying to optimize it, since I knew this would be the fastest way to do it.
...
And there is also a simpler brute force solution. I think the author of the question intended to promote this approach.

I was so trapped into this thought of back tracking that I could not see the simple brute force solution.
